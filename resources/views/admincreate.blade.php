...
@section('title')
    <title>Tenant Pro | Admin Create User</title>
@endsection
@section('content')
   ...
   <div class="smaller-box">
    ...
    <div class="row">
        <div class="col">
            ...
            <input type="text" class="small-input" name="name" required>
        </div>
        <div class="col">
            <label>Password</label>
            <input type="password" class="small-input" name="password"required>
        </div>
    </div>
